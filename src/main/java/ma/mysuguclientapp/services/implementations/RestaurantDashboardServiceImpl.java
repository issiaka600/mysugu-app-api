...
public class RestaurantDashboardServiceImpl {
    ...
    public RestaurantDashboardDTO getDashboard(Long restaurantId) {
        ...
        return RestaurantDashboardDTO.builder()
                ...
                .commissionAujourdhui(commandeRepository.sumCommissionRestaurant(restaurantId, debutJour, now))
                ...
                .commissionSemaine(commandeRepository.sumCommissionRestaurant(restaurantId, debutSemaine, now))
                ...
                .commissionMois(commandeRepository.sumCommissionRestaurant(restaurantId, debutMois, now))
                ...
                .totalCommission(commandeRepository.sumCommissionRestaurant(restaurantId, debut1970, debut2099))
